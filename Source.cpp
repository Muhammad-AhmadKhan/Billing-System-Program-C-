	...
	while (getline(toSearchDirectory, tempInfo))
	{
		if (count == 0)
		{
			for (i = 0; i < tempInfo.length(); i++)
			{
				...
				{
					itemInfo[0] = tempInfo;
					cout << " ------------------------------------" << endl << " IC Number\t|" << itemInfo[0] << endl;
					tempWord = "";
					count++;
					break;
				}
		...
		else if (count == 1)
		{
			...
			{
				itemInfo[1] = tempInfo;
				cout << " IC Description\t|" << itemInfo[1] << endl;
				count++;
				continue;
			}
		}
...
void Account::showReceipt()
{
	...
	cout << endl;
	cout << "\t\t    ID\t\tIC Number\tQuantity\tPrice\t\tIC Description" << endl;
	for (int i = 0; i < 10; i++)
	{
		cout << "\t\t    ";
		for (int j = 0; j < 5; j++)
...
void Account::displayList()
{
	...
	cout << endl;
	cout << "\t\tID\t\tIC Description\t\t\tIC Number\t\tQuantity" << endl;
	for (int i = 0; i < 10; i++)
	{
		cout << "\t\t";
		for (int j = 0; j < 4; j++)
...
void Account::completeCheckout()
{
	...
	cout << "\t\t\t\t\t\t             Delivery Charges:  " << dcharges << endl;
	cout << "\t\t\t\t\t\t\t\t  Grand Total:\t" << total + dcharges << endl;
	cout << "\t\t    ----------------------------------------------------------------------" << endl;
	cout << "\t\t    \t\t  THIS ORDER WAS APPROVED BY IC MASTER ADMINISTRATION\t\t" << endl;
	cout << "\t\t     Address: D.A.V College Rd, Naya Mohalla, Rawalpindi, Punjab 46000\t\t" << endl;
	cout << "\t\t    ----------------------------------------------------------------------" << endl;
	cout << "\t\t      Hotline: (555) 654 321 ----------- Email: management@icmaster.com" << endl;
	cout << "\t\t    ----------------------------------------------------------------------" << endl << endl;
...
void logoDisplay()
{
	...
	ti = localtime(&tt);
	cout << endl;
	cout << " ___  _________       _____      _____    _________________________________________ " << endl;
	cout << "|   | \\_   ___ \\     /     \\    /  _  \\  /   _____/\\__    ___/\\_   _____/\\______   \\" << endl;
	cout << "|   | /    \\  \\/    /  \\ /  \\  /  /_\\  \\ \\_____  \\   |    |    |    __)_  |       _/" << endl;
	cout << "|   | \\     \\____  /    Y    \\/    |    \\/        \\  |    |    |        \\ |    |   \\         " << asctime(ti);
	cout << "|___|  \\______  /  \\____|__  /\\____|__  /_______  /  |____|   /_______  / |____|_  /" << endl;
	cout << "             \\/           \\/         \\/        \\/                    \\/         \\/ " << endl;
	cout << endl;
}